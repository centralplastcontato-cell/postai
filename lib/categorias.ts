...
// Ordem e textos pensados pro nicho de BUFFET INFANTIL. `desc` ajuda a IA a classificar.
export const CATEGORIAS: { id: CategoriaId; rotulo: string; emoji: string; desc: string }[] = [
  ...
  { id: "prova_social", rotulo: "Prova social", emoji: "⭐", desc: "depoimento de cliente, festa que já rolou, 'olha como ficou linda'" },
  { id: "oferta", rotulo: "Promoção / preço", emoji: "🏷️", desc: "desconto, brinde, pacote, condição especial, valores em destaque" },
  { id: "institucional", rotulo: "Por que escolher", emoji: "💎", desc: "diferenciais, confiança, qualidade, motivos pra fechar com a marca" },
  { id: "sazonal", rotulo: "Data / sazonal", emoji: "🎂", desc: "datas comemorativas (Natal, Dia das Crianças), aniversariantes da semana" },
  { id: "conteudo", rotulo: "Dica / conteúdo", emoji: "💡", desc: "dica útil, ideia de festa, conteúdo de valor sem oferta" },
];
