...
- O piloto automático roda na NUVEM (pg_cron no Supabase chama `/api/cron/postar` com `CRON_SECRET`, de hora em hora) — não depende de máquina local. Batimento na tabela `Heartbeat`.
