  ...
  return (
    <div>
      ...
      <div className="mt-6">
        ...
        {aba === "mascote" && <MascoteEstudio marcaId={marca.id} mascoteUrl={marca.mascoteUrl ?? ""} mascotes={marca.mascotesArte ?? []} ficha3d={marca.mascoteFicha3d ?? ""} clipes={marca.mascoteClipes ?? []} clipesMeta={marca.mascoteClipesMeta ?? {}} corMarca={marca.corPrimaria} voz={marca.mascoteVoz ?? ""} abertura={marca.mascoteAbertura ?? ""} fecho={marca.mascoteFecho ?? ""} />}
