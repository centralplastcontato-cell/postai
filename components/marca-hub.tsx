...
export function MarcaHub({
  ...
  return (
    <div>
      ...
      <div className="mt-6">
        {aba === "redes" && <RedesSociais marcaId={marca.id} posts={posts} publicacoes={publicacoes} diasCarrossel={marca.diasCarrossel} diasFeed={marca.diasFeed} paleta={marca.paleta} temFacebook={Boolean(marca.fbPageId)} />}
