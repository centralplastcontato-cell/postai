...
// Etiqueta de CATEGORIA DE INTENÇÃO de um post (🏰 Mostrar o espaço, ⭐ Prova social…).
...
export function EtiquetaCategoria({ categoria }: { categoria?: string | null }) {
  ...
  return (
    <span
      title="Categoria de intenção — a Bia usa isso pra descobrir o que mais vende festa"
