...
export function RedesSociais({
  ...
  temMascote?: boolean; // a marca tem mascote oficial → habilita o controle nos posts
  temLogo?: boolean; // a marca tem logo → habilita o controle de posição/tamanho do logo
}) {
